...
| [GDPR](user-guides/Gpdr.md)              | Request and manage account deletion (GDPR) |
...
| [Project Dependencies](diagrams/ProjectDependencies.md) | Clean Architecture layer dependency diagram |
