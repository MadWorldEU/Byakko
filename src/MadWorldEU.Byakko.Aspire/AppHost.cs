...
var (keycloak, keycloakAdminClientSecret) = builder.BuildKeyCloak();
...
var api = resourceFactory.CreateApiBuilder(byakkoDb, localStack, keycloak, keycloakAdminClientSecret, mailPit);
